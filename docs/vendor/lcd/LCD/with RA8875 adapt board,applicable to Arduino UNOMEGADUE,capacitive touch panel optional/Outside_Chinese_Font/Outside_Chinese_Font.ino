...
Examples for ER-TFTM101A1-1  Outside Chinese Font
...
void loop() {
 ...
 unsigned char f []={0xC9,0xEE,0xDB,0xDA,0xD0,0xF1,0xC8,0xD5,0xB6,0xAB,0xB7,0xBD,0xBF,0xC6,0xBC,0xBC,0x00};  //GBK 
 	...
 	while(1)
	{
		...
		LCD_Print_Outside_Font_String(20,280,Red,White,f);
	
		ER5517.Font_Width_X2();
		ER5517.Font_Height_X2();
		LCD_Print_Outside_Font_String(20,315,Green,Black,f);

		ER5517.Font_Width_X3();
		ER5517.Font_Height_X3();
		LCD_Print_Outside_Font_String(20,375,Cyan,White,f);
	
		ER5517.Font_Width_X4();
		ER5517.Font_Height_X4();
		LCD_Print_Outside_Font_String(20,455,Yellow,Black,f);
		...
		LCD_Print_Outside_Font_String(20,105,Red,White,f);
	
		ER5517.Font_Width_X2();
		ER5517.Font_Height_X2();
		LCD_Print_Outside_Font_String(20,165,Green,Black,f);

		ER5517.Font_Width_X3();
		ER5517.Font_Height_X3();
		LCD_Print_Outside_Font_String(20,250,Blue,White,f);
	
		ER5517.Font_Width_X4();
		ER5517.Font_Height_X4();
		LCD_Print_Outside_Font_String(0,360,Yellow,Black,f);
